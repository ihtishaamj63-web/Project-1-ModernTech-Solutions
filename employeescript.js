...
const SALARY_TIERS = {
  Development: [
    {
      id: "junior",
      label: "Junior Developer (R50,000 - R65,000)",
      min: 50000,
      max: 65000,
    },
    {
      id: "mid",
      label: "Mid Developer (R65,000 - R80,000)",
      min: 65000,
      max: 80000,
    },
    {
      id: "senior",
      label: "Senior Developer (R70,000 - R100,000)",
      min: 70000,
      max: 100000,
    },
    {
      id: "lead",
      label: "Lead/Architect (R100,000 - R150,000)",
      min: 100000,
      max: 150000,
    },
  ],
  HR: [
    {
      id: "entry",
      label: "Entry Level (R40,000 - R55,000)",
      min: 40000,
      max: 55000,
    },
    {
      id: "mid",
      label: "Mid Level (R55,000 - R75,000)",
      min: 55000,
      max: 75000,
    },
    {
      id: "senior",
      label: "Manager (R75,000 - R100,000)",
      min: 75000,
      max: 100000,
    },
  ],
  QA: [
    {
      id: "junior",
      label: "Junior QA (R40,000 - R50,000)",
      min: 40000,
      max: 50000,
    },
    ...
    {
      id: "senior",
      label: "Senior QA (R55,000 - R80,000)",
      min: 55000,
      max: 80000,
    },
  ],
  Sales: [
    {
      id: "rep",
      label: "Representative (R45,000 - R55,000)",
      min: 45000,
      max: 55000,
    },
    {
      id: "acct",
      label: "Account Manager (R55,000 - R75,000)",
      min: 55000,
      max: 75000,
    },
    {
      id: "lead",
      label: "Sales Lead (R60,000 - R90,000)",
      min: 60000,
      max: 90000,
    },
  ],
  Marketing: [
    {
      id: "junior",
      label: "Junior (R40,000 - R50,000)",
      min: 40000,
      max: 50000,
    },
    {
      id: "mid",
      label: "Mid Level (R50,000 - R65,000)",
      min: 50000,
      max: 65000,
    },
    {
      id: "senior",
      label: "Senior (R58,000 - R80,000)",
      min: 58000,
      max: 80000,
    },
  ],
  Design: [
    {
      id: "junior",
      label: "Junior Designer (R45,000 - R55,000)",
      min: 45000,
      max: 55000,
    },
    {
      id: "mid",
      label: "Mid Designer (R55,000 - R70,000)",
      min: 55000,
      max: 70000,
    },
    {
      id: "senior",
      label: "Senior Designer (R65,000 - R85,000)",
      min: 65000,
      max: 85000,
    },
  ],
  IT: [
    {
      id: "support",
      label: "IT Support (R45,000 - R60,000)",
      min: 45000,
      max: 60000,
    },
    {
      id: "sysadmin",
      label: "SysAdmin (R60,000 - R80,000)",
      min: 60000,
      max: 80000,
    },
    {
      id: "senior",
      label: "Senior IT (R72,000 - R100,000)",
      min: 72000,
      max: 100000,
    },
  ],
  Finance: [
    {
      id: "junior",
      label: "Junior (R45,000 - R55,000)",
      min: 45000,
      max: 55000,
    },
    {
      id: "mid",
      label: "Mid Level (R55,000 - R70,000)",
      min: 55000,
      max: 70000,
    },
    {
      id: "senior",
      label: "Senior (R62,000 - R90,000)",
      min: 62000,
      max: 90000,
    },
  ],
  Support: [
    {
      id: "rep",
      label: "Representative (R40,000 - R50,000)",
      min: 40000,
      max: 50000,
    },
    {
      id: "senior",
      label: "Senior Support (R50,000 - R70,000)",
      min: 50000,
      max: 70000,
    },
  ],
...
function employeeSetDate() {
  const dateEl =
    document.getElementById("empPageDate") ||
    document.getElementById("employee-todayDate");
  if (!dateEl) return;
  const today = new Date();
  dateEl.textContent = today.toLocaleDateString("en-ZA", {
    weekday: "long",
    day: "numeric",
    month: "long",
    year: "numeric",
...
function employeeSetupModal() {
  ...
  if (!modal) return;
  document
    .getElementById("employee-cancelDelete")
    ?.addEventListener("click", () => {
      modal.classList.add("hidden");
      employeeToDelete = null;
    });
  document
    .getElementById("employee-confirmDelete")
    ?.addEventListener("click", () => {
      if (employeeToDelete !== null) {
        employeeAll = employeeAll.filter(
          (e) => e.employeeId !== employeeToDelete,
        );
        employeeSave();
  ...
  modal.querySelector(".emp-modal__backdrop")?.addEventListener("click", () => {
    modal.classList.add("hidden");
    employeeToDelete = null;
  });
}
...
async function employeeLoad() {
  ...
  if (stored) {
    employeeAll = JSON.parse(stored);
    return;
  }
  try {
    const res = await fetch("employee_info.json");
    const data = await res.json();
    employeeAll = data.employeeInformation.map((emp) => ({
      ...emp,
      status: "Active",
    }));
    employeeSave();
    ...
    employeeAll = [];
    employeeShowToast("Failed to load employee data", "error");
  }
}
...
function employeeSave() {
  ...
  try {
    window.dispatchEvent(new Event("moderntech:dataUpdated"));
  } catch (e) {}
}
...
function employeeRenderFilters() {
  ...
  filterContainer.innerHTML = departments
    .map(
      (dept) =>
        `<button class="emp-filter ${dept === "All" ? "active" : ""}" data-dept="${dept}">${dept}</button>`,
    )
    .join("");
  filterContainer.addEventListener("click", (e) => {
    if (e.target.classList.contains("emp-filter")) {
      document
        .querySelectorAll(".emp-filter")
...
function employeeStatusBadge(status) {
  const map = {
    ...
    "On Leave": "emp-badge--leave",
    Terminated: "emp-badge--term",
  };
...
function employeeRenderCard(employees) {
  ...
  const actionHeader = isHR ? "<div>Action</div>" : "";
  list.innerHTML = `
    <div class="emp-row__head emp-row">
      <div>Name</div><div>ID</div><div>Dept</div><div>Position</div>
      <div>Contact</div><div>Salary</div><div>Status</div>${actionHeader}
    </div>
    ${employees
      .map((emp) => {
        const actionCell = isHR
          ? `<div data-label="Action" style="display:flex;gap:6px;">
      ...
      <div class="emp-row">
        <div class="emp-row__name" data-label="Name">
          <div class="emp-row__avatar">${employeeGetInitials(emp.name)}</div>
          <span>${emp.name}</span>
        </div>
        ...
        <div data-label="Status">${employeeStatusBadge(emp.status)}</div>
        ${actionCell}
      </div>`;
      })
      .join("")}
...
function employeeApplyFilters() {
  ...
  if (employeeCurrentFilter !== "All")
    filtered = filtered.filter(
      (emp) => emp.department === employeeCurrentFilter,
    );
  if (searchTerm) {
    filtered = filtered.filter(
      (emp) =>
...
function employeeSetupSearch() {
  document
    .getElementById("employee-searchInput")
    ?.addEventListener("input", employeeApplyFilters);
}
...
function employeeInitAddPage() {
  ...
  if (editId) {
    const stored = JSON.parse(
      localStorage.getItem("editingEmployee") || "null",
    );
    if (stored && stored.employeeId == editId) {
      ...
      document.getElementById("employee-startDate").value =
        stored.startDate || "";
      document.getElementById("employee-history").value =
        stored.employmentHistory || "";
      employeeToEdit = stored;
    }
  }

  document
    .getElementById("employee-addForm")
...
function employeeUpdate(employeeId) {
  ...
  if (index === -1) {
    employeeShowToast("Employee not found", "error");
    return;
  }
...
function employeeAdd() {
  ...
  const newId =
    employeeAll.length > 0
      ? Math.max(...employeeAll.map((e) => e.employeeId)) + 1
      : 1;
  ...
  const newEmployee = {
    ...
    contact,
    status: "Active",
    employmentHistory: history || `Joined in ${dateObj.getFullYear()}`,
    startDate,
  };
...
function populatePositionSelect(dept) {
  const posSelect = document.getElementById("employee-position");
  if (!posSelect) return;
  if (posSelect.tagName.toLowerCase() !== "select") {
    const select = document.createElement("select");
    select.id = "employee-position";
    select.required = true;
    posSelect.parentNode.replaceChild(select, posSelect);
  }
  ...
  if (!options.length) {
    const set = new Set();
    Object.values(POSITION_MAP).forEach((arr) =>
  ...
  if (employeeToEdit && employeeToEdit.position) {
    select.value = employeeToEdit.position;
  }
}
...
function populateSalaryRanges(department) {
  ...
  const tiers = SALARY_TIERS[department] || [
    ...
    {
      id: "senior",
      label: "Senior Level (R75,000 - R100,000)",
      min: 75000,
      max: 100000,
    },
    {
      id: "lead",
      label: "Lead/Manager (R100,000 - R150,000)",
      min: 100000,
      max: 150000,
    },
  ];
  ...
  select.innerHTML =
    ...
    tiers
      .map(
        (t) =>
          `<option value='${t.id}' data-min='${t.min}' data-max='${t.max}'>${t.label}</option>`,
      )
      .join("");
  ...
  select.addEventListener("change", function () {
    ...
    if (min && max && salaryInput) {
      const mid = Math.round((min + max) / 2);
      salaryInput.value = mid;
